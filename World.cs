...
namespace Projekat
{
    public class World : IDisposable
    {
        ...
        public float[] airplane_pos = { -1.4f, -8.5f, -10f };
        public float[] airplane_light_pos = { -1.4f, 0f, -10f, 1 };
        ...
        public void Draw()
        {
            ...
            Gl.glPushMatrix();
            {
                ...
                Gl.glLightfv(Gl.GL_LIGHT3, Gl.GL_POSITION, airplane_light_pos);

                Gl.glTranslatef(airplane_light_pos[0],airplane_light_pos[1],airplane_light_pos[2]);
            ...
            Gl.glPushMatrix();
            {
                ...
                Gl.glScalef(0.1f, 0.1f, 0.1f);
                Gl.glTranslatef(airplane_pos[0],airplane_pos[1],airplane_pos[2]);
